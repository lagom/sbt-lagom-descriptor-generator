...
2. Before starting to work on a feature or a fix, make sure that there is a ticket for your work in the [issue tracker](https://github.com/lagom/sbt-lagom-descriptor-generator/issues). If not, create it first.
3. Perform your work according to the [pull request requirements](#pull-request-requirements).
4. When the feature or fix is completed you should open a [Pull Request](https://help.github.com/articles/using-pull-requests) on [GitHub](https://github.com/lagom/sbt-lagom-descriptor-generator/pulls).
...
In case of questions about the contribution process or for discussion of specific issues please visit the [lagom/contributors gitter chat](https://gitter.im/lagom/contributors).
...
2. [Scalariform](https://github.com/scala-ide/scalariform) enforces some of the code style rules.
